  ...
  return (
    ...
    <section className="grid grid-cols-1 gap-4 lg:grid-cols-12">
      {showGenerationTrend ? (
        ...
        >
          <div className="mb-2 flex justify-end">
            <label htmlFor="generation-area" className="mr-2 text-sm text-slate-600 dark:text-slate-400">
              表示エリア
            </label>
            <select
              id="generation-area"
      ...
      {showSourceComposition ? (
        ...
        >
          <div className="mb-2 flex justify-end">
            <label htmlFor="source-donut-area" className="mr-2 text-sm text-slate-600 dark:text-slate-400">
              表示エリア
            </label>
            <select
