...
const JAPAN_ISLAND_COORDS: Array<{ name: string; coords: Array<[number, number]> }> = [
  {
    ...
    coords: [
      ...
      [45.52, 141.94], [45.46, 141.75], [45.42, 141.69],
      // Northeast coast (Okhotsk Sea)
      [45.38, 141.85], [45.35, 142.10], [45.28, 142.18],
      [45.15, 142.30], [45.05, 142.38], [44.92, 142.50],
      [44.80, 142.68], [44.65, 142.90], [44.52, 143.10],
      [44.40, 143.30], [44.28, 143.55], [44.15, 143.85],
      [44.08, 144.05], [44.00, 144.25], [43.97, 144.45],
      // Shiretoko Peninsula
      [43.95, 144.65], [43.98, 144.80], [44.05, 144.95],
      [44.18, 145.08], [44.33, 145.20], [44.25, 145.32],
      [44.10, 145.38], [43.98, 145.35], [43.85, 145.30],
      // East coast (Nemuro / Nosappu)
      [43.70, 145.48], [43.55, 145.70], [43.45, 145.78],
      [43.38, 145.82], [43.35, 145.70], [43.30, 145.55],
      [43.22, 145.32], [43.10, 145.05], [43.05, 144.72],
      [42.98, 144.40], [42.92, 144.08],
      // South coast (Pacific)
      [42.85, 143.85], [42.80, 143.65], [42.68, 143.48],
      [42.55, 143.30], [42.42, 143.18], [42.30, 143.10],
      [42.15, 143.15], [41.93, 143.24], // Cape Erimo
      [42.00, 143.05],
      // Southwest coast
      [42.05, 142.82], [42.12, 142.55], [42.22, 142.32],
      [42.32, 142.08], [42.40, 141.92], [42.50, 141.75],
      [42.57, 141.65], [42.63, 141.55], [42.67, 141.38],
      [42.70, 141.20], [42.68, 141.05],
      // Uchiura Bay (噴火湾)
      [42.62, 140.95], [42.55, 140.88], [42.45, 140.92],
      [42.32, 140.97], [42.28, 140.78], [42.20, 140.55],
      [42.12, 140.45], [42.05, 140.40], [42.00, 140.47],
      [41.95, 140.55], [41.88, 140.63],
      // Oshima Peninsula (Hakodate)
      [41.82, 140.70], [41.77, 140.73], [41.68, 140.70],
      [41.58, 140.68], [41.53, 140.62], [41.48, 140.42],
      [41.43, 140.11], // Matsumae
      [41.48, 140.02],
      // West coast (Japan Sea)
      [41.55, 139.98], [41.65, 139.95], [41.78, 139.90],
      [41.90, 139.87], [42.05, 139.84], [42.18, 139.82],
      [42.35, 139.82], [42.55, 139.83], [42.68, 139.87],
      [42.82, 139.92], [42.92, 139.98],
      [43.00, 140.05], [43.08, 140.15], [43.15, 140.25],
      // Shakotan Peninsula
      [43.25, 140.35], [43.33, 140.45], [43.30, 140.58],
      [43.23, 140.68], [43.20, 140.78], [43.18, 140.88],
      [43.18, 140.98],
      // Northwest coast
      [43.20, 141.12], [43.23, 141.25], [43.30, 141.33],
      [43.40, 141.42], [43.52, 141.48], [43.65, 141.55],
      [43.80, 141.60], [43.95, 141.63], [44.10, 141.67],
      [44.25, 141.70], [44.45, 141.72], [44.65, 141.73],
      [44.80, 141.73], [44.95, 141.73], [45.10, 141.72],
      [45.25, 141.70], [45.35, 141.69],
  ...
  },
  {
    ...
    coords: [
      ...
      [41.45, 140.21], [41.40, 140.34], [41.35, 140.47],
      [41.25, 140.62], [41.16, 140.78], [41.22, 140.90],
      [41.32, 141.02], [41.35, 141.18], [41.38, 141.37], // Shimokita tip
      [41.28, 141.48],
      // Pacific coast – Tōhoku
      [41.15, 141.55], [41.05, 141.62], [40.92, 141.72],
      [40.75, 141.80], [40.65, 141.85], [40.55, 141.90],
      [40.42, 141.88], [40.28, 141.82], [40.12, 141.85],
      [39.95, 141.90], [39.80, 141.95], [39.63, 141.97],
      [39.48, 141.96], [39.30, 141.93], [39.15, 141.88],
      [39.02, 141.82], [38.88, 141.75], [38.73, 141.68],
      [38.60, 141.58], [38.45, 141.50], [38.38, 141.40],
      [38.30, 141.28], [38.20, 141.15], [38.10, 141.05],
      [37.95, 141.00],
      // Sendai → Kantō
      [37.80, 140.95], [37.68, 140.98], [37.55, 141.00],
      [37.38, 140.98], [37.15, 140.92], [36.98, 140.90],
      [36.80, 140.87], [36.65, 140.83], [36.50, 140.80],
      [36.35, 140.72], [36.20, 140.63], [36.07, 140.58],
      [35.93, 140.53], [35.85, 140.68],
      // Chōshi / Bōsō Peninsula
      [35.77, 140.83], [35.68, 140.75], [35.55, 140.62],
      [35.42, 140.45], [35.25, 140.25], [35.13, 140.08],
      [35.05, 139.95], [35.00, 139.88], [34.95, 139.82],
      // Tokyo Bay west shore
      [35.02, 139.78], [35.12, 139.73], [35.22, 139.70],
      [35.33, 139.68], [35.42, 139.70], [35.45, 139.72],
      [35.45, 139.68], [35.42, 139.63], [35.36, 139.58],
      [35.30, 139.55], [35.22, 139.42],
      // Sagami Bay → Izu Peninsula
      [35.15, 139.15], [35.13, 139.10], [35.10, 139.05],
      [35.05, 139.00], [35.00, 138.98], [34.95, 139.02],
      [34.90, 139.08], [34.82, 139.05], [34.70, 138.95],
      [34.63, 138.88],
      [34.58, 138.80], // Cape Irozaki (Izu tip)
      [34.62, 138.70], [34.68, 138.60], [34.75, 138.53],
      [34.82, 138.48],
      // Suruga Bay / Enshu-nada
      [34.87, 138.38], [34.90, 138.28], [34.82, 138.22],
      [34.72, 138.18], [34.68, 137.95], [34.65, 137.82],
      [34.63, 137.70], [34.62, 137.52], [34.60, 137.35],
      [34.63, 137.18], [34.68, 137.03],
      // Ise Bay
      [34.70, 136.93], [34.73, 136.85], [34.70, 136.88],
      [34.65, 136.90], [34.60, 136.82], [34.55, 136.72],
      [34.48, 136.75], [34.35, 136.80], [34.28, 136.68],
      [34.20, 136.55], [34.08, 136.30],
      // Kii Peninsula
      [33.95, 136.05], [33.90, 135.98], [33.85, 135.93],
      [33.72, 135.88], [33.58, 135.83],
      [33.47, 135.78], // Cape Shio-no-misaki (Kii tip)
      [33.52, 135.58], [33.58, 135.45], [33.65, 135.35],
      [33.73, 135.23], [33.82, 135.12], [33.88, 135.08],
      [33.95, 135.03],
      // Osaka Bay / Kansai
      [34.08, 135.00], [34.18, 135.00], [34.28, 135.02],
      [34.35, 135.07], [34.40, 135.10], [34.52, 135.18],
      [34.65, 135.23], [34.68, 135.15],
      // Inland Sea coast / Chūgoku
      [34.62, 135.05], [34.55, 134.85], [34.48, 134.75],
      [34.38, 134.65], [34.28, 134.48], [34.15, 134.25],
      [34.18, 134.00], [34.25, 133.75], [34.25, 133.48],
      [34.22, 133.20], [34.20, 132.92], [34.15, 132.65],
      [34.12, 132.48], [34.08, 132.30], [34.07, 132.15],
      [34.05, 132.00],
      // Western Honshu tip
      [34.02, 131.90], [33.98, 131.82], [34.00, 131.68],
      [34.05, 131.55], [34.12, 131.38], [34.20, 131.22],
      [34.12, 131.08], [33.98, 130.95], // Shimonoseki
      // Japan Sea coast – San'in
      [34.05, 130.98], [34.15, 131.05], [34.25, 131.18],
      [34.38, 131.35], [34.48, 131.45], [34.60, 131.55],
      [34.68, 131.65], [34.75, 131.73], [34.90, 131.88],
      [35.08, 132.00], [35.18, 132.22], [35.28, 132.42],
      [35.35, 132.55], [35.38, 132.78], [35.42, 133.00],
      [35.47, 133.18], [35.52, 133.38], [35.55, 133.62],
      [35.58, 133.88], [35.60, 134.05], [35.63, 134.25],
      [35.60, 134.55], [35.58, 134.78], [35.55, 135.05],
      // Wakasa Bay
      [35.55, 135.35], [35.60, 135.52], [35.65, 135.65],
      [35.72, 135.78], [35.73, 135.90], [35.75, 136.00],
      [35.82, 136.08], [35.92, 136.15],
      // Noto Peninsula
      [36.08, 136.22], [36.25, 136.35], [36.35, 136.48],
      [36.45, 136.58], [36.60, 136.65], [36.72, 136.68],
      [36.80, 136.72], [36.95, 136.72],
      [37.08, 136.72], [37.20, 136.82], [37.30, 136.93], // Noto tip
      [37.25, 137.05], [37.15, 137.15],
      [37.00, 137.08], [36.85, 136.95],
      // Niigata coast
      [36.88, 137.05], [36.95, 137.20], [37.10, 137.48],
      [37.22, 137.65], [37.30, 137.80], [37.42, 137.95],
      [37.55, 138.12], [37.70, 138.35], [37.85, 138.55],
      [37.98, 138.92],
      // Tōhoku Japan Sea coast
      [38.10, 139.30], [38.25, 139.38], [38.38, 139.45],
      [38.50, 139.50], [38.65, 139.52], [38.82, 139.55],
      [38.95, 139.72], [39.12, 139.92], [39.32, 139.93],
      [39.55, 139.93], [39.72, 139.88], [39.88, 139.84],
      [40.05, 139.83], [40.22, 139.82], [40.38, 139.83],
      [40.52, 139.86], [40.62, 139.90],
      // Back to Tsugaru
      [40.75, 140.00], [40.85, 140.12], [40.95, 140.25],
      [41.05, 140.30], [41.15, 140.35], [41.30, 140.28],
      [41.45, 140.21],
    ],
  },
  {
    ...
    coords: [
      // NE (Naruto area)
      [34.25, 134.68], [34.18, 134.72], [34.08, 134.78],
      // East coast → Cape Muroto
      [33.98, 134.72], [33.90, 134.68], [33.85, 134.60],
      [33.75, 134.45], [33.65, 134.32], [33.60, 134.20],
      [33.48, 134.20], [33.38, 134.18],
      [33.25, 134.17], // Cape Muroto
      // South coast → Cape Ashizuri
      [33.18, 134.05], [33.10, 133.88], [33.05, 133.60],
      [33.02, 133.48], [32.98, 133.35], [32.90, 133.22],
      [32.82, 133.12],
      [32.73, 133.02], // Cape Ashizuri
      [32.78, 132.85], [32.82, 132.72],
      // West coast (Uwa Sea)
      [32.88, 132.60], [32.93, 132.55], [33.00, 132.48],
      [33.10, 132.42], [33.18, 132.40], [33.28, 132.42],
      [33.38, 132.52], [33.50, 132.65], [33.58, 132.73],
      [33.68, 132.82], [33.78, 132.88], [33.88, 132.95],
      // North coast (Seto Inland Sea)
      [33.95, 132.98], [34.00, 133.00], [34.03, 133.12],
      [34.08, 133.30], [34.10, 133.45], [34.15, 133.60],
      [34.18, 133.75], [34.22, 133.88], [34.27, 134.00],
      [34.32, 134.10], [34.35, 134.25], [34.38, 134.40],
      [34.33, 134.55], [34.25, 134.68],
    ],
  },
  {
    name: "kyushu",
    coords: [
      // NE (Kitakyushu)
      [33.95, 131.02], [33.92, 130.95], [33.88, 130.85],
      // North coast (Fukuoka)
      [33.78, 130.68], [33.65, 130.45], [33.60, 130.40],
      [33.55, 130.35], [33.42, 130.20], [33.30, 130.05],
      [33.22, 129.98],
      // West coast (Nagasaki)
      [33.10, 129.95], [33.00, 129.85], [32.92, 129.78],
      [32.82, 129.73],
      [32.73, 129.70], // Nagasaki area
      [32.67, 129.72], [32.60, 129.75], [32.58, 129.88],
      [32.55, 130.00], [32.48, 130.08],
      // Yatsushiro / Amakusa
      [32.42, 130.13], [32.35, 130.18], [32.22, 130.25],
      [32.10, 130.30], [31.95, 130.33], [31.80, 130.35],
      [31.68, 130.40],
      // Satsuma Peninsula
      [31.55, 130.48], [31.45, 130.52], [31.35, 130.55],
      [31.22, 130.57], [31.10, 130.58],
      [30.98, 130.65], // Cape Nagasakibana
      [31.05, 130.72],
      // Kagoshima Bay → Ōsumi Peninsula
      [31.15, 130.78], [31.25, 130.75], [31.38, 130.72],
      [31.48, 130.75], [31.55, 130.78], [31.50, 130.88],
      [31.42, 130.95], [31.35, 131.00],
      [31.18, 131.03], [31.02, 131.07], // Cape Sata
      [31.08, 131.20],
      // East coast (Miyazaki)
      [31.18, 131.35], [31.28, 131.40], [31.40, 131.43],
      [31.52, 131.44], [31.65, 131.44], [31.78, 131.43],
      [31.90, 131.42], [32.08, 131.50], [32.18, 131.55],
      [32.25, 131.60], [32.38, 131.65], [32.55, 131.72],
      [32.68, 131.78],
      // NE coast (Ōita)
      [32.82, 131.83], [32.93, 131.82], [33.05, 131.80],
      [33.12, 131.75], [33.20, 131.70], [33.28, 131.62],
      [33.38, 131.55], [33.48, 131.38], [33.55, 131.25],
      [33.58, 131.18], [33.68, 131.08], [33.78, 131.00],
      [33.88, 131.00],
      [33.95, 131.02],
    ],
  },
  {
    ...
    coords: [
      // North tip
      [26.88, 128.26], [26.85, 128.22], [26.80, 128.20],
      [26.78, 128.18], [26.72, 128.10], [26.68, 128.05],
      [26.65, 127.98], [26.60, 127.93], [26.55, 127.88],
      [26.50, 127.85], [26.45, 127.82], [26.42, 127.80],
      [26.38, 127.77], [26.32, 127.73], [26.28, 127.70],
      [26.22, 127.68], [26.15, 127.65], [26.08, 127.65],
      // South tip → return north (west coast)
      [26.12, 127.68], [26.15, 127.70], [26.22, 127.73],
      [26.28, 127.77], [26.33, 127.80], [26.40, 127.83],
      [26.45, 127.87], [26.52, 127.92], [26.58, 127.98],
      [26.63, 128.03], [26.70, 128.12], [26.75, 128.17],
      [26.82, 128.22], [26.85, 128.24],
      [26.88, 128.26],
    ],
  },
];
